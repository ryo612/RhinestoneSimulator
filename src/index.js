...
// controls.dampingFactor = 0.2;
  ...
  for (let i = 0; i < p_stock.length; i++) {
    const ll=parseInt(p_stock[i])+parseInt(1);
    bgTexture.push(new THREE.TextureLoader().load("src/P0" + ll + ".png"));
    //bgTexture.push(new THREE.TextureLoader().load("src/P01.png"));
    //alert("src/P0" + ll + ".png");
